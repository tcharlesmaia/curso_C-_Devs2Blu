...
namespace Devs2Blu.ProjetosAula.OOP3.Main.Cadastros
{
    public class CadastroPaciente : IMenuCadastro
    {
        ...
        public void Excluir()
        {
            Paciente aciente = new Paciente();
            Console.Clear();
            int codigoaciente;

            Console.WriteLine("Informe o Paciente que Deseja Excluir:\n");
            ListarPacientesByCodeAndName();
            Int32.TryParse(Console.ReadLine(), out codigoaciente);

            aciente = Program.Mock.ListaPacientes.Find(p => p.CodigoPaciente == codigoaciente);
